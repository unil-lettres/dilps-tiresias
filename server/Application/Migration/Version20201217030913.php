...
class Version20201217030913 extends IrreversibleMigration
{
    public function up(Schema $schema): void
    {
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');

        $this->addSql('CREATE TABLE export (id INT AUTO_INCREMENT NOT NULL, creator_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, updater_id INT DEFAULT NULL, collection_id INT DEFAULT NULL, creation_date DATETIME DEFAULT NULL, update_date DATETIME DEFAULT NULL, card_count INT UNSIGNED NOT NULL, filename VARCHAR(2000) DEFAULT \'\' NOT NULL, state ENUM(\'todo\', \'in_progress\', \'done\') DEFAULT \'todo\' NOT NULL COMMENT \'(DC2Type:ExportState)\', format ENUM(\'zip\', \'pptx\', \'xlsx\') DEFAULT \'zip\' NOT NULL COMMENT \'(DC2Type:ExportFormat)\', max_height INT UNSIGNED DEFAULT 0 NOT NULL, include_legend TINYINT(1) DEFAULT \'1\' NOT NULL, text_color VARCHAR(255) DEFAULT \'#FFFFFF\' NOT NULL, background_color VARCHAR(255) DEFAULT \'#000000\' NOT NULL, site ENUM(\'dilps\', \'tiresias\') NOT NULL COMMENT \'(DC2Type:Site)\', file_size INT NOT NULL, INDEX IDX_428C169461220EA6 (creator_id), INDEX IDX_428C16947E3C61F9 (owner_id), INDEX IDX_428C1694E37ECFB0 (updater_id), INDEX IDX_428C1694514956FD (collection_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE export ADD CONSTRAINT FK_428C1694514956FD FOREIGN KEY (collection_id) REFERENCES collection (id) ON DELETE SET NULL');

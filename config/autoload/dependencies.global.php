...
return [
    ...
    'dependencies' => [
        ...
        'factories' => [
            ...
            \Application\Handler\PptxHandler::class => \Application\Handler\PptxFactory::class,
            \Application\Handler\XlsxHandler::class => \Application\Handler\XlsxFactory::class,
            \Application\Handler\TemplateHandler::class => \Application\Handler\TemplateFactory::class,
            \Application\Handler\ZipHandler::class => \Application\Handler\ZipFactory::class,
